...
public class FlutterAppauthPlugin
    ...
    private void createAuthorizationServices() {
        if (defaultAuthorizationService == null) {
            ...
            authConfigBuilder.setBrowserMatcher(
                    // According to Singpass demo app, there was an issue with Edge browser, so set it on deny list
                    new BrowserDenyList(
            ...
            defaultAuthorizationService = new AuthorizationService(this.applicationContext, authConfigBuilder.build());
        }
    ...
    private void performAuthorization(
        ...
        if (additionalParameters != null && !additionalParameters.isEmpty()) {
            ...
            String codeVerifier = additionalParameters.get("codeVerifier");
